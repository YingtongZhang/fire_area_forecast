...
for(icomp in 1:46){
  if((icomp >= s_icomp) & (icomp <= e_icomp)){
    ...
    cmd = sprintf('wget --user yingtong_zhang --password 921113 -A %s -r -nH -np -nv --cut-dirs=4 https://e4ftl01.cr.usgs.gov/MOLT/MOD14A2.006/%s/', accept_tile_string, date_str)
